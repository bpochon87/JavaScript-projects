var intro=("Good day, friend."); // Assigning variable 'intro' its string value.
    window.alert(intro); // Pop-up window displaying 'intro' variable.
...
document.write((3 + 9) / 4); // Displaying value of expression.

document.write(intro.fontcolor("blue")) // Assigned a deprecated method to color 'intro' blue.